...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        @include('score_calculate.header')
        <!--begin::Content-->
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            <div class="w-100 mw-150px">
                                ...
                                <!--begin::Select2-->
                                <select class="form-select  filter-select" data-name="nganh_id" data-control="select2"
                                    data-placeholder="Ngành">
                                    <option></option>
                            ...
                            <input type="hidden" id="id_da_xoa" />
                            <input type="hidden" id="so_luong_sv_them" class="btn-them" value='0' />
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="frm-table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-nowrap" data-name="stop_study_types">{{ __('Các chế độ hưởng') }}</th>
                                    <th class="text-nowrap" data-name="thao_tac">{{ __('Thao tác') }}</th>
                                </tr>
                            </thead>
    ...
    @include('score_calculate.validate')
    @include('score_calculate.xacnhanDS', ['target' => 'xacnhanDS'])
    @include('score_calculate.table')
@endsection
