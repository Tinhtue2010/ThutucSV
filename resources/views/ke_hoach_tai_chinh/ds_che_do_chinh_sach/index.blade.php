...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        @include('ke_hoach_tai_chinh.ds_che_do_chinh_sach.header')
        <!--begin::Content-->
    ...
    @include('ke_hoach_tai_chinh.ds_che_do_chinh_sach.table')
    @include('ke_hoach_tai_chinh.ds_che_do_chinh_sach.xacnhanDS', ['target' => 'xacnhanDS'])
    @include('giao_vien.chitiet', ['target' => 'chitiet'])
    @include('giao_vien.tientrinh', ['target' => 'tientrinh'])
    @include('ke_hoach_tai_chinh.ds_che_do_chinh_sach.quyen_dinh_danh_sach',['target' => 'quyen_dinh_danh_sach'])
@endsection
