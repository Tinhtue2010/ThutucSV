...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        @include('ke_hoach_tai_chinh.header')
        <!--begin::Content-->
    ...
    @include('ke_hoach_tai_chinh.table')
    @include('ke_hoach_tai_chinh.xacnhan', ['target' => 'xacnhan'])
    @include('ke_hoach_tai_chinh.khongxacnhan', ['target' => 'khongxacnhan'])
