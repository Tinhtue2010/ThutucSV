...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        @include('ke_hoach_tai_chinh.ds_mien_giam_hp.header')
        <!--begin::Content-->
    ...
    @include('ke_hoach_tai_chinh.ds_mien_giam_hp.table')
    @include('ke_hoach_tai_chinh.ds_mien_giam_hp.xacnhanDS',['target'=>'xacnhanDS'])
