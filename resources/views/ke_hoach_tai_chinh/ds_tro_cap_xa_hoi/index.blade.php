...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        @include('ke_hoach_tai_chinh.ds_tro_cap_xa_hoi.header')
        <!--begin::Content-->
    ...
    @include('ke_hoach_tai_chinh.ds_tro_cap_xa_hoi.table')
    @include('giao_vien.chitiet',['target'=>'chitiet'])
    @include('giao_vien.tientrinh',['target'=>'tientrinh'])
    @include('ke_hoach_tai_chinh.ds_tro_cap_xa_hoi.xacnhanDS',['target'=>'xacnhanDS'])
@endsection
