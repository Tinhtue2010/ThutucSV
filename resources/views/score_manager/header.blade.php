            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="d-flex w-100 flex-wrap">
                        <div id="import-file"
                            class="btn btn-flex btn-primary fs-7 fw-bold position-relative cursor-pointer me-3 "> 
                            <input class="m-0 p-0 top-0 left-0 w-100 h-100 position-absolute" style="opacity: 0"
                                type="file" id="avatar" name="avatar" accept=".csv" />
                            {{ __('Cập nhật điểm') }}
                        </div>
                        <div onclick="thongKe()" class="btn btn-secondary">Thống kê</div>
                    </div>
                </div>
                <!--end::Toolbar wrapper-->
            </div>
