                    ...
                    <form action="" id="form_create">
                        ...
                        <div class="d-flex flex-column mb-1 fv-row">
                            ...
                            <select
                                ...
                                readonly @endif
                                @endif name="doituong" class="form-select  filter-select"
                                data-name="year" data-control="select2" data-placeholder="Năm">
                                <option value="0">Học sinh, sinh viên là người dân tộc thiểu số ở vùng cao từ 03
                                    năm trở lên.</option>
                                <option value="1">Học sinh, sinh viên mồ côi cả cha lẫn mẹ không nơi nương tựa.
                                </option>
                                <option value="2">Học sinh, sinh viên là người tàn tật gặp khó khăn về kinh tế.
                                </option>
                                <option value="3">Học sinh, sinh viên có hoàn cảnh đặc biệt khó khăn về kinh
                                    tế, vượt khó học tập, gia đình thuộc diện xóa đói giảm nghèo.</option>
                            </select>
                        </div>
                        <div class="fs-6 fw-semibol d-flex flex-column">
                            <p class="100">
                                @if (Str::startsWith(\Route::currentRouteName(), 'TroCapXH'))
                                    <input name="trocapxh" class="form-check-input d-none" type="checkbox"
                                        value="1"checked />
                                    <b>Đối tượng</b> <br>
                                    <label class="ms-4">
                                        Đối tượng được hưởng chế độ Trợ cấp xã hội là một trong những trường hợp
                                        sau: <br>
                                        - Học sinh, sinh viên là người dân tộc thiểu số ở vùng cao từ 03 năm trở
                                        lên. <br>
                                        ...
                                        - Học sinh, sinh viên có hoàn cảnh đặc biệt khó khăn về kinh tế, vượt khó
                                        học tập, gia đình thuộc diện xóa đói giảm nghèo.
                                    </label> <br>
                                    <b>Hồ sơ minh chứng cần thiết</b> <br>
                                    <label class="ms-4">
                                        1- Giấy tờ minh chứng về nơi cư trú đối với SV ở vùng cao từ 3 năm trở
                                        lên. <br>
                                        2- Bản phô tô công chứng Giấy chứng tử của bố mẹ. <br>
                                        3- Bản phô tô công chứng Giấy khai sinh đối với những học sinh, sinh viên là
                                        mồ côi cha mẹ. <br>
                                        4- Bản phô tô công chứng Giấy chứng nhận của cơ quan y tế về tình trạng bị
                                        khuyết tật, tàn tật đối với những SV khuyết tật, tàn tật. <br>
                                        5- Bản phô tô công chứng sổ hộ nghèo hoặc hộ cận ghèo đói với những sinh viên
                                        có hoàn cảnh đặc biệt khó khăn <br>
                                    </label>
                                @else
                                    <input name="trocaphp" class="form-check-input d-none" type="checkbox"
                                        value="1"checked />
                                    <b>Đối tượng</b> <br>
                                    <label class="ms-4">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            <!--begin::Label-->
                            <label class="d-flex align-items-center fs-6 fw-semibold mb-2">
                                <span class="required">Hồ sơ xin hưởng chế độ trợ cấp kèm theo giấy này gồm:</span>
                            </label>
                            <!--end::Label-->
                            <textarea
                                @if (isset($don_parent)) @if ($don_parent->status > 0)
                                readonly @endif
                                @endif class="form-control h-150px" name="hoso">{{ $phieu['hoso'] ?? '' }}</textarea>
                        </div>
