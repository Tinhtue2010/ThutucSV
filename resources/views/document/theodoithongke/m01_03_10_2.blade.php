                ...
                <tr style="height: 160px">
                    <td class="align-top">
                        <div class="fw-bold fst-italic lh-1">
                            Quyết định Hỗ trợ chi phí học tập cho SV học kỳ {{ $data[0]['ky'] }}, năm
                            học {{ $data[0]['nam'] }}.Số Quyết định {{ $data[0]['so_QD'] }}, ngày {{ $data[0]['thoi_gian_tao_ngay'] }} tháng {{ $data[0]['thoi_gian_tao_thang'] }} năm {{ $data[0]['thoi_gian_tao_nam'] }}. <br />
                            <div class="fst-normal fw-medium ms-1 mt-1">
                              Tổng số HSSV được hỗ trợ: {{ $data[0]['tong_hs'] }} <br />
