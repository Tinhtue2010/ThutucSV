...
@section('data')
    <style>
        ...
        <div class="d-flex flex-row justify-content-between">
            <div>
                ...
                <div style="
                    ...
                    margin-right: auto;
                    "></div>
                <div class="text-center mt-2">Số: {{ $data[0]['so_QD_KTX_1'] }}/QĐ-ĐHHL</div>
        ...
        <div class="fw-bold text-center mx-auto">
            Về việc miễn phí chỗ ở tại Kí túc xá theo điểm g, khoản 3, điều 1<br>
            Nghị quyết 35/2021/NQ-HĐND ngày 27/8/2021 của Hội đồng nhân dân <br>
            tỉnh Quảng Ninh, học kỳ {{ $data[0]['ky'] == '1' ? 'I' : 'II' }} năm học {{ $data[0]['nam'] }}
        </div>
        <div style="
                    width: 150px;
                    height: 1px;
        ...
        <div style="text-align: justify; ">
            <p class="mb-1"><b>&emsp;&emsp;&emsp;Điều 1.</b>
                Thực hiện chế độ miễn phí chỗ ở tại Kí túc xá học kỳ {{$data[0]['ky']}} năm học {{$data[0]['nam']}} cho {{$data[0]['tong_hs_cdktx_1']}} sinh viên hệ đại học có hộ khẩu thường trú tại tỉnh Quảng Ninh, thuộc đối tượng dân tộc thiểu số sống tại khu vực I miền núi, đối tượng hoàn thành nghĩa vụ quân sự (theo điểm g, khoản 3, điều 1, Nghị quyết 35/2021/NQ-HĐND).
            </p>
        </div>
