...
@section('data')
    <div id="doc_view" class="A4 d-flex flex-column" style="height: auto;">
        ...
        <div class="fst-italic text-center mx-auto" style="max-width: 85%">
            (Kèm theo quyết định số {{ $data[0]['so_QD_HP'] }}/QĐ-ĐHHL, ngày {{ $data[0]['thoi_gian_tao_ngay'] }} tháng {{ $data[0]['thoi_gian_tao_thang'] }} năm {{ $data[0]['thoi_gian_tao_nam'] }}
            <br>
      ...
      ">
                <tr class="text-center p-0">
                    ...
                    <th class="border border-1 border-black">Xếp loại</th>
                    <th class="border border-1 border-black">% Học phí được hỗ trợ</th>
                    <th class="border border-1 border-black">Số tiền học phí/tháng</th>
                    <th class="border border-1 border-black">Số tháng được hỗ trợ</th>
                    <th class="border border-1 border-black">Số tiền hỗ trợ học phí/kỳ</th>
                ...
                <tr style="height: 30px">
                    <td class="" colspan="9">&nbsp;&nbsp;Tổng: {{$data[0]['tong_cdhp']}}</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
        ...
        <div class="d-flex flex-row justify-content-between px-5 mt-1">
            <div class="d-flex justify-content-end text-center fw-bold align-items-baseline">
              <span>số tiền bằng chữ:</span></span><span class="fw-light ms-1"> {{ numberInVietnameseCurrency($data[0]['tong_cdhp']) }}
              </div>
