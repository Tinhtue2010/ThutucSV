...
@section('data')
    ...
    <div id="doc_view" class="A4 d-flex flex-column times-font vietnamese-text" style="height: auto;">
        <table style="width: 100%;">
            <tr>
                <td style="text-align: center; vertical-align: top;">
                    ...
                    <div style="margin-top: 8px;">Số: {{ $data[0]['so_QD_HP'] }}/QĐ-ĐHHL</div>
                </td>
                <td style="text-align: center; vertical-align: top;">
                    <div class="text-center">CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM</div>
                    <div class="text-center fw-bold">Độc lập – Tự do – Hạnh phúc</div>
                    <div style="width: 94px; height: 1px; background-color: black; margin: 2px auto 0 auto;"></div>
                    <div class="text-center mt-2">Quảng ninh, ngày {{ $data[0]['thoi_gian_tao_ngay'] }} tháng
                        {{ $data[0]['thoi_gian_tao_thang'] }} năm {{ $data[0]['thoi_gian_tao_nam'] }}</div>
                </td>
            </tr>
        </table>
        ...
        <div style="text-align: justify;  font-style: italic;">
            <p class="mb-1">
                &emsp;&emsp;&emsp;Căn cứ Nghị quyết số 35/2021/NQ-HĐND ngày 27/08/2021 của Hội đồng nhân dân tỉnh Quảng Ninh
                về việc quy định chính sách thu hút, đào tạo nguồn nhân lực chất lượng cao tại Trường Đại học Hạ Long,
                Trường Cao đẳng Việt – Hàn Quảng Ninh và Trường Cao đẳng Y tế Quảng Ninh giai đoạn 2021 – 2025;
            </p>
            <p class="mb-1">
                &emsp;&emsp;&emsp;Căn cứ Quyết định số 2551/QĐ-UBND ngày 12/8/2016 của Uỷ ban nhân dân tỉnh Quảng Ninh về
                việc Quy định chức năng, nhiệm vụ, quyền hạn và cơ cấu tổ chức của Trường Đại học Hạ Long; Quyết định số
                416/QĐ-UBND ngày 09 tháng 02 năm 2021 của Uỷ ban nhân dân tỉnh Quảng Ninh về việc kiện toàn cơ cấu tổ chức
                của Trường Đại học Hạ Long;
            </p class="mb-1">
            <p class="mb-1">
                &emsp;&emsp;&emsp;Căn cứ Hồ sơ sinh viên thuộc điểm g, Nghị quyết số 35/2021/NQ-HĐND ngày 27/08/2021 của Hội
                đồng nhân dân tỉnh Quảng Ninh;
            </p>
            <p class="mb-1">
                &emsp;&emsp;&emsp;Căn cứ điểm trung bình chung học tập và điểm rèn luyện học kỳ {{ $data[0]['ky'] }}, năm
                học {{ $data[0]['nam'] }} của sinh viên các ngành đào tạo: Quản trị dịch vụ du lịch và lữ hành, Quản trị
                khách sạn, Quản trị nhà hàng và dịch vụ ăn uống, Ngôn ngữ Nhật, Ngôn ngữ Hàn Quốc, Ngôn ngữ Trung Quốc, Nuôi
                trồng thủy sản đang học tại Trường Đại học Hạ Long;
            </p>
            <p class="mb-1">
        ...
        <div style="text-align: justify; ">
            <p class="mb-1"><b>&emsp;&emsp;&emsp;Điều 1.</b>
                Thực hiện chế độ hỗ trợ học phí theo điểm c, g, khoản 3, điều 1, Nghị quyết 35/2021/NQ-HĐND, học kỳ
                {{ $data[0]['ky'] }} năm học {{ $data[0]['nam'] }} cho {{ $data[0]['tong_hs_cdhp'] }} sinh viên hệ đại
                học các ngành: Quản trị dịch vụ du lịch và lữ hành, Quản trị khách sạn, Quản trị nhà hàng và dịch vụ ăn
                uống, Ngôn ngữ Nhật, Ngôn ngữ Hàn Quốc, Ngôn ngữ Trung quốc, Nuôi trồng thủy sản.</p>
        </div>
        <div style="text-align: justify; ">
        ...
        <div style="text-align: justify; ">
            <p class="mb-1"><b>&emsp;&emsp;&emsp;Điều 3.</b> Trưởng các phòng: Công tác tác chính trị, Quản lý và Hỗ trợ
