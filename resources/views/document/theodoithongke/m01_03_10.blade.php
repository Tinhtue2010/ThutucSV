...
@section('data')
        ...
        <div class="text-center d-flex flex-column">
            ...
            <span>Vấn đề trình: Trình ký duyệt trợ cấp xã hội</span>
        </div>
        <div class="d-flex flex-column mt-3">
            <table class="" style="border-collapse: collapse; ">
                ...
                <tr style="height: 160px">
                    <td class="align-top">
                        <div class="fw-bold fst-italic lh-1">
                            Quyết định Trợ cấp xã hội cho SV học kỳ {{ $data[0]['ky'] }}, năm học {{ $data[0]['nam'] }} Quyết
                            định {{ $data[0]['so_QD'] }}, ngày {{ $data[0]['thoi_gian_tao_ngay'] }} tháng {{ $data[0]['thoi_gian_tao_thang'] }} năm {{ $data[0]['thoi_gian_tao_nam'] }} <br />
                            <div class="fst-normal fw-medium ms-1 mt-1 mb-2">
                              Tổng số HSSV được trợ cấp: {{ $data[0]['tong_hs'] }}  <br />
                              Tổng số tiền: {{ $data[0]['tong'] }} <br />
                            </div>
                          </div>
                    </td>
                    <td></td>
