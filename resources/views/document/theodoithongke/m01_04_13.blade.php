                ...
                <tr style="height: 160px">
                    <td class="align-top" >
                        <p class="fw-bold fst-italic">
                            1. Quyết định về việc thực hiện chế độ hỗ trợ tiền ăn hàng tháng cho SV học kỳ {{ $data[0]['ky'] }},
                            năm học {{ $data[0]['nam'] }} Số Quyết định {{ $data[0]['so_QD_TA'] }},
                            ...
                            <span class="fst-normal fw-medium" >
                                Tổng số HSSV được hưởng:  {{$data[0]['tong_hs_cdta']}}<br />
                                Tổng số tiền: {{$data[0]['tong_cdta']}}<br />
                            </span>
                        </p>
                        <p class="fw-bold fst-italic">
                            2. Quyết định về việc hỗ trợ học phí theo điểm c, g, khoản 3, điều 1
                            Nghị quyết 35/2021/NQ-HĐND 
                             cho SV học kỳ {{ $data[0]['ky'] }},
                            năm học {{ $data[0]['nam'] }} Số Quyết định {{ $data[0]['so_QD_HP'] }},
                            ngày {{ $data[0]['thoi_gian_tao_ngay'] }} tháng {{ $data[0]['thoi_gian_tao_thang'] }} năm {{ $data[0]['thoi_gian_tao_nam'] }} <br>
                            <span class="fst-normal fw-medium">
                                Tổng số HSSV được hưởng:  {{$data[0]['tong_hs_cdhp']}}<br />
                                Tổng số tiền: {{$data[0]['tong_cdhp']}}<br />
                            </span>
                        </p>
                        <p class="fw-bold fst-italic">
                            3. Quyết định về việc miễn phí chỗ ở tại Kí túc xá theo điểm g, khoản 3, điều 1
                            Nghị quyết 35/2021/NQ-HĐND 
                             cho SV học kỳ {{ $data[0]['ky'] }},
                            năm học {{ $data[0]['nam'] }} Số Quyết định {{ $data[0]['so_QD_KTX_1'] }},
                            ngày {{ $data[0]['thoi_gian_tao_ngay'] }} tháng {{ $data[0]['thoi_gian_tao_thang'] }} năm {{ $data[0]['thoi_gian_tao_nam'] }} <br>
                            <span class="fst-normal fw-medium">
                                Tổng số HSSV được hưởng:  {{$data[0]['tong_hs_cdktx_1']}}<br />
                            </span>
                        </p>
                        <p class="fw-bold fst-italic">
                            4. Quyết định về việc miễn phí chỗ ở tại Kí túc xá theo điểm g, khoản 3, điều 1
                            Nghị quyết 35/2021/NQ-HĐND 
                             cho SV học kỳ {{ $data[0]['ky'] }},
                            năm học {{ $data[0]['nam'] }} Số Quyết định {{ $data[0]['so_QD_KTX_4'] }},
                            ngày {{ $data[0]['thoi_gian_tao_ngay'] }} tháng {{ $data[0]['thoi_gian_tao_thang'] }} năm {{ $data[0]['thoi_gian_tao_nam'] }} <br>
                            <span class="fst-normal fw-medium">
                                Tổng số HSSV được hưởng:  {{$data[0]['tong_hs_cdktx_4']}}<br />
                            </span>
                        </p>
                    </td>
                    <td></td>
