...
@section('data')
    <style>
        ...
        <div class="fw-bold text-center mx-auto">
            Về việc miễn phí chỗ ở tại Kí túc xá theo điểm e, khoản 3, điều 1<br>
            Nghị quyết 35/2021/NQ-HĐND ngày 27/8/2021 của Hội đồng nhân dân tỉnh<br>
        ...
        <div style="text-align: justify; ">
            <p class="mb-1"><b>&emsp;&emsp;&emsp;Điều 1.</b>
                Thực hiện chế độ miễn phí chỗ ở tại kí túc xá học kỳ {{$data[0]['ky']}} năm học {{$data[0]['nam']}} theo điểm e, khoản 3, điều 1, Nghị quyết 35/2021/NQ-HĐND, cho {{$data[0]['tong_hs_cdktx_4']}} sinh viên hệ đại học .
            </p>
        </div>
