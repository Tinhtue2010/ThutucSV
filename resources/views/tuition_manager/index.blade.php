...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        @include('tuition_manager.header')
        <!--begin::Content-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="frm-table">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="text-nowrap" data-name="hoc_phi">{{ __('Học phí') }}</th>
                                </tr>
                            </thead>
    ...
    @include('tuition_manager.validate')
    @include('tuition_manager.table')
    @include('tuition_manager.update')
    @include('tuition_manager.import')
    @include('tuition_manager.change_pass')
    @include('tuition_manager.create', ['target' => 'tuition'])
