                    ...
                    <div class="w-100 justify-content-end flex-wrap d-flex">
                        <div class="card-toolbar">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <a href="{{ route('LanhDaoTruong.CheDoChinhSach.index') }}" target="_blank" class="menu-link px-3">Danh sách chế độ chính sách</a>
                                </div>
                                <!--end::Menu item-->
                            </div>
                            <!--end::Menu 3-->
                    ...
                    <div class="w-100 d-flex">
                        @if ($tb_miengiamhp > 0)
                            <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-2 w-100">
                                ...
                                <a href="{{ route('LanhDaoTruong.MienGiamHP.index') }}" target="_blank" class="btn btn-primary">Chi tiết</a>
                            </div>
                        @endif
                        @if ($tb_trocapxahoi > 0)
                            <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-2 w-100">
