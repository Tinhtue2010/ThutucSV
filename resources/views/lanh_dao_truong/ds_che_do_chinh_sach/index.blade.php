...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        @include('lanh_dao_truong.ds_che_do_chinh_sach.header')
        <!--begin::Content-->
    ...
    @include('lanh_dao_truong.ds_che_do_chinh_sach.table')
    @include('lanh_dao_truong.ds_che_do_chinh_sach.xacnhanDS', ['target' => 'xacnhanDS'])
    @include('giao_vien.chitiet', ['target' => 'chitiet'])
    @include('giao_vien.tientrinh', ['target' => 'tientrinh'])
    @include('lanh_dao_truong.ds_che_do_chinh_sach.quyen_dinh_danh_sach',['target' => 'quyen_dinh_danh_sach'])
@endsection
