...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        @include('lanh_dao_truong.ds_tro_cap_xa_hoi.header')
        <!--begin::Content-->
    ...
    @include('lanh_dao_truong.ds_tro_cap_xa_hoi.table')
    @include('giao_vien.chitiet',['target'=>'chitiet'])
    @include('giao_vien.tientrinh',['target'=>'tientrinh'])
    @include('lanh_dao_truong.ds_tro_cap_xa_hoi.xacnhanDS',['target'=>'xacnhanDS'])
@endsection
