                ...
                <form class="form" id="form_{{$target}}">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <textarea type="text" class="form-control form-control-solid" cols="5" rows="3" name="note">Đơn của bạn đã được phòng đào tạo xác nhận</textarea>
                        </div>
