@push('js')
    <script>
        $('#btn_doituong').click(function(e) {
            Swal.fire({
    title: "Thông báo",
    html: `
        <div style="text-align: left; line-height: 1.5;">
            <b>Đối tượng 1:</b> Đối tượng được hưởng chế độ hỗ trợ tiền ăn, hỗ trợ học phí và hỗ trợ chỗ ở phải là sinh viên có hộ khẩu thường trú tại tỉnh Quảng Ninh thuộc diện:
            <ul>
            ...
            <br>
            <b>Đối tượng 4:</b> Đối tượng được hưởng chế độ hỗ trợ chỗ ở là sinh viên một trong 7 ngành quy định trên có điểm trung bình chung học tập, điểm rèn luyện trong học kỳ xếp loại từ Khá trở lên (thang 10, điểm trung bình chung học tập lớn hơn hoặc bằng 7.0 và điểm rèn luyện từ 65 điểm trở lên) và khoảng cách từ trường đến nhà từ 15 km trở lên.
        </div>
    `,
    width: '800px',
    maxWidth: '95%',
    ...
    if (result.isConfirmed) {
        console.log("Đã cập nhật tất cả thông tin");
    } else if (result.dismiss === Swal.DismissReason.cancel) {
        console.log("Chưa cập nhật đủ");
    }
});
