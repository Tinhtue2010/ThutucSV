...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        @include('lanh_dao_phong_dao_tao.ds_tro_cap_hoc_phi.header')
        <!--begin::Content-->
    ...
    @include('lanh_dao_phong_dao_tao.ds_tro_cap_hoc_phi.table')
    @include('lanh_dao_phong_dao_tao.ds_tro_cap_hoc_phi.xacnhanDS',['target'=>'xacnhanDS'])
