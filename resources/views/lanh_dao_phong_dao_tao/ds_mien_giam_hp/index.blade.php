...
@section('content')
    <div class="d-flex flex-column flex-column-fluid">
        @include('lanh_dao_phong_dao_tao.ds_mien_giam_hp.header')
        <!--begin::Content-->
    ...
    @include('lanh_dao_phong_dao_tao.ds_mien_giam_hp.table')
    @include('lanh_dao_phong_dao_tao.ds_mien_giam_hp.xacnhanDS',['target'=>'xacnhanDS'])
