...
class DanhSachHoSoSinhVienExport implements FromArray, WithEvents, WithDrawings
{
    protected $data;
    ...
    public function array(): array
    {
        $result = [
            ...
            [''],
            ['STT', 'Loại hồ sơ', 'Tên file', 'Mã sinh viên', 'Tên sinh viên', 'Thời gian'],
        ];
        $stt = 1;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $this->applyBorder($sheet, 'A6:F' . $sheet->getHighestRow());
                $this->centerCell($sheet, 'A1:F'.$sheet->getHighestRow());
                $this->boldCell($sheet, 'A1:F6');
